<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        else
        {
            ...
            // update history
            CS50::query("INSERT INTO history (user_id, transaction, symbol, shares, price, withdrawl) VALUES (?, ?, ?, ?, ?, ?)", $_SESSION["id"], $transaction, $_POST["symbol"], $_POST["shares"], $stock["price"], $cost);
